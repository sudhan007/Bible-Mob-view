...
<div className="pt-4 p-3">
 <Link to="/forgetpassword"> <i className="fa-solid fa-arrow-left mt-3" style={{color:  "white"}}></i></Link>
  <div className="mt-5">
      <h3 className="text-center login">Login to send OTP with mobile number</h3>
  </div>


  <form action="#" className="mt-4 p-1">
      <div className="d-flex justify-content-between  flex-nowrap">
      
          <input type="tel" className="verifyotp" value="2" maxlength="1" />
          <input type="tel" className="verifyotp" value="5" maxlength="1" />
          <input type="tel" className="verifyotp" value="7" maxlength="1" />
          <input type="tel" className="verifyotp" value="5" maxlength="1" />
          <input type="tel" className="verifyotp" value="6" maxlength="1" />
          <input type="tel" className="verifyotp" value="2" maxlength="1" />

      </div>
      <div className="mt-5">
        <Link to="/resetpassword">  <input type="submit"  value="Submit" className="inputsub1 input1  mt-5" /></Link>
