...
let Detailadmin = () => {
  ...
  let clickSub = async (dat) => {
    ...
    navigate("/admin/detail" + "/" + pro + "/" + hash);
    setContent(!content);
  };
  ...
  let uploadAudio = async (datt) => {
    ...
    if (
      ...
      let responce = await axios
        .post(`${BaseUrluser}/addaudio`, formData, {
          headers: {
  ...
  let Bookview = (dat) => {
    navigate("/admin/bookview" + "/" + dat._id);
  };
              ...
              {bookstatus === true && subcatdet === false ? (
                <>
                  ...
                  <div
                    ...
                    className="mt-4 mb-3"
                    onClick={() => {
                      handleImageUpload(commoonid._id);
                    }}
                  >
                    <p style={{ color: "#000", textAlign: "center" }}>Upload</p>
                  </div>
                </>
              ) : bookstatus === true && subcatdet === true ? (
                <>
      ...
      >
        {editss === 0 ? (
          <>
            ...
            <div>
              <p style={{ color: "#000", marginBottom: 10 }}>
                Sub Category Name
              </p>
              <input
                onChange={(e) => {
