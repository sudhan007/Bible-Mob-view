...
function Mobmessageview() {
  ...
  return (
    ...
    <div className="container-md px-0">
      <div
        className="row "
        style={{ backgroundColor: "#720272", padding: "15px" }}
      >
        <div className="col-2">
      ...
      {/* <div
        className="row py-3"
        style={{ backgroundColor: "rgba(65, 0, 65, 1)" }}
      >
        ...
        <div className="col-6 p-0 text-center">
          <div>
            <button
              style={{
                padding: "8px 6px",
                backgroundColor: "rgba(114, 2, 114, 1)",
                border: "0",
                marginTop: "-2px",
              }}
            >
...
<div class="row text-center"  style={{backgroundColor: "rgba(65, 0, 65, 1)",padding: "10px 0px"}}>

<div class="col-1 p-0 ">
<button style={{border: "0",padding: "5px",backgroundColor: "rgba(114, 2, 114, 1)"}}><i class="fa fa-chevron-left" style={{color: "white"}}></i></button>
</div>
<div class="col-10 p-0 pt-2" style={{backgroundColor: "white",color: "black",fontSize: "10px",fontWeight: "700"}}>
  47-04-12 விசுவாசமானது சாரம்சமாயிருக்கிறது
</div>
<div class="col-1 p-0">
  <button style={{border: "0",padding: "5px",backgroundColor: "rgba(114, 2, 114, 1)"}}><i class="fa fa-chevron-right" style={{color: "white"}}></i></button>
</div>
        ...
        <div>
          ...
          <button
            style={{
              ...
              border: "0",
              borderRadius: "50%",
              backgroundColor: "rgba(232, 215, 231, 1)",
            }}
          >
            <svg
              width="13"
            ...
            >
              ...
              />
              <path
                d="M10.5763 4.56616H13V11.2954H10.5763V4.56616Z"
                fill="#720272"
              />
            </svg>
          </button>
...
textDecoration: "none"}}> MESSAGE </a>
    ...
    {/* <main className="container-md">
        <div className="row " style={{ paddingRight: "16px" }}>
          <div className="col-12 p-2">
            <div>
              <span>
                <i
                  className="fa-solid fa-circle-xmark"
                  style={{ fontSize: "30px", color: "rgba(114, 2, 114, 1)" }}
                ></i>
              </span>{" "}
              &nbsp; &nbsp;
            ...
            <div className="mt-5 row">
              <div style={{ height: "570px", overflow: "scroll" }}>
                ...
                >
                  47-11-23 இஸ்ரவேலின் புத்திரர்கள்
                </p>
                <hr style={{ color: "rgba(114, 2, 114, 1)" }} />
                ...
                >
                  50-01-00 வியாதிகளும் துன்பங்களும்
                </p>
                <hr style={{ color: "rgba(114, 2, 114, 1)" }} />
                ...
                >
                  50-07-15 ஆவியானவரால் வழி நடத்தப்படுதல்
                </p>
                <hr style={{ color: "rgba(114, 2, 114, 1)" }} />
              </div>
            </div>
